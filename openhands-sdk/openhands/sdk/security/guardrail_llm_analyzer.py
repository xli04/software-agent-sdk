...
Example (bare guardrail):
    ...
    >>> analyzer = GuardrailLLMSecurityAnalyzer(llm=guardrail_llm)
...
def _format_action_for_guardrail(action: ActionEvent) -> str:
    ...
    if action.action is not None:
        ...
        try:
            args_repr = action.tool_call.function.arguments
        except AttributeError:
            args_repr = str(action.tool_call)
...
class GuardrailLLMSecurityAnalyzer(SecurityAnalyzerBase):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        logger.info(
            "GuardrailLLMSecurityAnalyzer initialized: "
